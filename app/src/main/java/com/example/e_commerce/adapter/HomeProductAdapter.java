...
public class HomeProductAdapter extends RecyclerView.Adapter<HomeProductAdapter.ViewHolder> {
    private List<ProductDatum> HomeProductList = new ArrayList<>();
    ...
    public void setHomeProductList(List<ProductDatum> OffersProductList) {
        this.HomeProductList = OffersProductList;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ProductDatum currentItem = HomeProductList.get(position);
